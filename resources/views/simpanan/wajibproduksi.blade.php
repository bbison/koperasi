...
@section('body')
    <div class="d-flex justify-content-center">
        <div class="col-8">
            <br>
            <br>
            <form action="/simpananWajibProduksi" method="get">
                @csrf
                <div class="d-flex">
            ...
            <div class="d-flex justify-content-end mt-3">
                <div>
                    ...
                    @if (request()->get('tanggal_awal'))
                        <a
                            href="/simpananWajibProduksi-download?tanggal_awal={{ request()->get('tanggal_awal') }}&tanggal_akhir={{ request()->get('tanggal_akhir') }}">
                    ...
                    @else
                        <a href="/simpananWajibProduksi-download">
